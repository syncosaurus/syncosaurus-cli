...
export class Dev extends Command {
  ...
  async run(): Promise<void> {
    ...
    if (inSyncoRoot) {
      ...
      const wranglerChildProcess: ExecaChildProcess<string> | null = execa(
        'wrangler',
        ['dev', './node_modules/syncosaurus/do/index.mjs'],
        {
          cwd: process.cwd(),
          env: process.env,
  ...
  private pressXtoExit(
    wranglerChildProcess: ExecaChildProcess<string> | null,
    viteChildProcess?: ExecaChildProcess<string> | null,
  ): void {
